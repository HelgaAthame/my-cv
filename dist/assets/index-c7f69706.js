var _=Object.defineProperty;var C=(m,e,t)=>e in m?_(m,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):m[e]=t;var d=(m,e,t)=>(C(m,typeof e!="symbol"?e+"":e,t),t);(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const l=(m,e)=>{const t=m.querySelector(e);if(!t)throw new Error(`There is no element with selector ${e}`);return t};class O{constructor(){}control(){this.addListeners(),this.addAnimation(),this.tooltips()}addListeners(){this.projectLinks(),this.educationLinks(),this.contactLinks()}addAnimation(){this.animatePhoto(),this.animateText(),this.visabilityText(),this.highlightPargs()}projectLinks(){const e=l(document,".gem-puzzle"),t=l(document,".bomberman"),n=l(document,".medical-center"),i=l(document,".online-store"),o=l(document,".online-zoo"),c=l(document,".song-bird"),y=l(document,".file-manager"),g=l(document,".websocket"),p=l(document,".crud-api"),h=l(document,".async-race"),u=l(document,".news-api");e.addEventListener("click",()=>window.open("https://rolling-scopes-school.github.io/helgaathame-JSFE2022Q3/src/","_blank")),t.addEventListener("click",()=>window.open("https://bomberman2d.netlify.app/","_blank")),n.addEventListener("click",()=>window.open("https://medcine-ath.netlify.app/","_blank")),i.addEventListener("click",()=>window.open("https://cadence-musical-instruments.netlify.app/home","_blank")),o.addEventListener("click",()=>window.open("https://rolling-scopes-school.github.io/helgaathame-JSFE2022Q3/online-zoo/","_blank")),c.addEventListener("click",()=>window.open("https://rolling-scopes-school.github.io/helgaathame-JSFE2022Q3/my-app/dist/","_blank")),y.addEventListener("click",()=>window.open("https://github.com/HelgaAthame/file-manager/tree/file-manager","_blank")),g.addEventListener("click",()=>window.open("https://github.com/HelgaAthame/websocket/tree/websocket","_blank")),p.addEventListener("click",()=>window.open("https://github.com/HelgaAthame/CRUD-api/tree/crud-api","_blank")),h.addEventListener("click",()=>window.open("https://github.com/rolling-scopes-school/helgaathame-JSFE2022Q3/pull/45","_blank")),u.addEventListener("click",()=>window.open("https://github.com/rolling-scopes-school/helgaathame-JSFE2022Q3/pull/43","_blank"))}educationLinks(){const e=l(document,".seo-course"),t=l(document,".node-js-course"),n=l(document,".javascript-course"),i=l(document,".academy-of-science"),o=l(document,".react-course"),c=l(document,".performance-optimization-course");e.addEventListener("click",()=>window.open("https://proseo.by/kursy/","_blank")),t.addEventListener("click",()=>window.open("https://rs.school/nodejs/","_blank")),n.addEventListener("click",()=>window.open("https://rs.school/js/","_blank")),i.addEventListener("click",()=>window.open("https://www.ipnk.basnet.by/","_blank")),o.addEventListener("click",()=>window.open("https://rs.school/react/","_blank")),c.addEventListener("click",()=>window.open("https://training.by/","_blank"))}contactLinks(){l(document,".codewars").addEventListener("click",()=>window.open("https://www.codewars.com/users/rsschool_9ece1d706006f744","_blank")),l(document,".github").addEventListener("click",()=>window.open("https://github.com/HelgaAthame","_blank")),l(document,".telegram").addEventListener("click",()=>window.open("https://t.me/HelgaAthame","_blank"))}animatePhoto(){const e=l(document,".info__wrapper"),t=l(document,".info__photo");t.addEventListener("mouseover",()=>{requestAnimationFrame(()=>{e.style.borderWidth="3.2rem",e.style.margin="-3rem",e.style.borderColor="rgba(200, 220, 250, 0)",t.style.filter="none",t.style.width="12rem",t.style.height="12rem",t.style.boxShadow="0 0 15px 1px rgba(50, 55, 65, 0.5), 0 0 4rem 0.5rem rgba(200, 220, 250, 0.5), -1rem -1rem 4rem 1rem #040812 inset, -2px -2px 10px 2px #040812 inset",e.style.width="12rem",e.style.height="12rem",t.style.backgroundSize="12rem"})}),t.addEventListener("mouseleave",()=>{requestAnimationFrame(()=>{e.style.borderWidth="0.2rem",e.style.margin="1rem",e.style.borderColor="rgba(200, 220, 250, 1)",t.style.filter="grayscale(50%) opacity(0.3) contrast(2)",t.style.width="10rem",t.style.height="10rem",e.style.width="10rem",e.style.height="10rem",t.style.backgroundSize="10rem",t.style.boxShadow="none"})})}animateText(){document.querySelectorAll(".flying").forEach(t=>{let n=!0;(function(){const o=Math.floor(Math.random()*1e3);let c=Number(Math.random().toFixed(2));const y=t.classList.contains("p1")?3:t.classList.contains("p2")?3.5:t.classList.contains("p3")?4:t.classList.contains("p4")?4.5:t.classList.contains("p5")?5:1;setTimeout(g,o);function g(){t.style.paddingTop=`${c}rem`,c>1.5&&(n=!1),c<0&&(n=!0),c=Number((n?c+.01*y:c-.01*y).toFixed(2)),requestAnimationFrame(g)}})()})}visabilityText(){document.querySelectorAll(".block").forEach(t=>{console.log("block");const n=Array.from(t.children);n.find(o=>o.classList.contains("p1"))&&(t.addEventListener("mouseover",()=>{console.log("mouse over"),n.forEach(o=>o.classList.remove("dontDisplay"))}),t.addEventListener("mouseout",()=>{console.log("mouse out"),n.forEach(o=>o.classList.contains("p1")?o.classList.add("displayIt"):o.classList.add("dontDisplay"))}))})}tooltips(){document.querySelectorAll(".with-tooltip").forEach(t=>t.addEventListener("mouseover",()=>{const n=document.createElement("div");n.className="tooltip";const i=t.dataset.tooltip;i&&(n.innerHTML=i),n.style.opacity="0",document.body.append(n);let o=0;(function p(){o=o+.2,n.style.opacity=o.toString(),o<1&&requestAnimationFrame(p)})();let c=t.getBoundingClientRect(),y=c.left+(t.offsetWidth-n.offsetWidth)/2;y<0&&(y=0);let g=c.top-n.offsetHeight-5;g<0&&(g=c.top+t.offsetHeight+5),n.style.left=y+"px",n.style.top=g+"px",t.addEventListener("mouseout",()=>{let p=1;(function h(){p=p-.2,n.style.opacity=p.toString(),p>0?requestAnimationFrame(h):n.remove()})()})}))}highlightPargs(){document.querySelectorAll("p").forEach(t=>{t.addEventListener("mouseover",()=>{t.style.textShadow="1px 1px 2px midnightblue, 0 0 1em rgb(200, 220, 250), 0 0 0.2em rgb(200, 220, 250) "}),t.addEventListener("mouseout",()=>{t.style.textShadow="none"})})}}class P{constructor(){}renderUI(){this.renderBG(),this.renderSpace(),this.createContent()}renderBG(){let e,t,n,i,o,p=0;const h=20,u=200;n=2*Math.PI,i=[],e=document.createElement("canvas"),document.body.append(e),b(),o={x:e.width/2,y:e.height/2},t=e.getContext("2d"),t||alert("Ooops! Your browser does not support canvas :'(");class M{constructor(s,r){d(this,"siblings");d(this,"anchorX");d(this,"x");d(this,"y");d(this,"vx");d(this,"vy");d(this,"energy");d(this,"radius");d(this,"brightness");d(this,"anchorY");this.anchorX=s,this.anchorX=r,this.x=Math.random()*(s-(s-h))+(s-h),this.y=Math.random()*(r-(r-h))+(r-h),this.vx=Math.random()*2-1,this.vy=Math.random()*2-1,this.energy=Math.random()*100,this.radius=Math.random(),this.siblings=[],this.brightness=0}drawNode(){var s="rgba(100, 110, 125, "+this.brightness+")";t&&(t.beginPath(),t.arc(this.x,this.y,2*this.radius+2*this.siblings.length/50,0,n),t.fillStyle=s,t.fill())}drawConnections(){for(var s=0;s<this.siblings.length;s++){var r="rgba(100, 110, 125, "+this.brightness+")";t&&(t.beginPath(),t.moveTo(this.x,this.y),t.lineTo(this.siblings[s].x,this.siblings[s].y),t.lineWidth=1-f(this,this.siblings[s])/50,t.strokeStyle=r,t.stroke())}}moveNode(){this.energy-=2,this.energy<1&&(this.energy=Math.random()*100,this.x-this.anchorX<-h?this.vx=Math.random()*2:this.x-this.anchorX>h?this.vx=Math.random()*-2:this.vx=Math.random()*4-2,this.y-this.anchorY<-h?this.vy=Math.random()*2:this.y-this.anchorY>h?this.vy=Math.random()*-2:this.vy=Math.random()*4-2),this.x+=this.vx*this.energy/100,this.y+=this.vy*this.energy/100}}function x(){t&&t.clearRect(0,0,e.width,e.height),i=[];for(var a=50;a<e.width;a+=50)for(var s=50;s<e.height;s+=50)i.push(new M(a,s)),p++}function f(a,s){return Math.sqrt(Math.pow(a.x-s.x,2)+Math.pow(a.y-s.y,2))}function T(){for(var a,s,r,v=0;v<p;v++){a=i[v],a.siblings=[];for(var k=0;k<p;k++)if(s=i[k],a!==s&&(r=f(a,s),r<50))if(a.siblings.length<50)a.siblings.push(s);else{for(var S=0,L=0,E,w=0;w<50;w++)S=f(a,a.siblings[w]),S>L&&(L=S,E=w);r<L&&(a.siblings.splice(E,1),a.siblings.push(s))}}}function D(){b(),t&&t.clearRect(0,0,e.width,e.height),T();var a,s,r;for(a=0;a<p;a++)s=i[a],r=f({x:o.x,y:o.y},s),r<u?s.brightness=1-r/u:s.brightness=0;for(a=0;a<p;a++)s=i[a],s.brightness&&(s.drawNode(),s.drawConnections()),s.moveNode();requestAnimationFrame(D)}function A(){document.addEventListener("resize",b,!1),document.addEventListener("mousemove",N,!1)}function b(){e.width=window.innerWidth,e.height=window.innerHeight}function N(a){o.x=a.clientX,o.y=a.clientY}A(),x(),D()}renderSpace(){const e=document.createElement("div");e.classList.add("space"),document.body.append(e);const t=500;({rand:function(){return Math.random()},createStar:function(){let i=document.createElement("div");return i.className="star",i},create:function(){for(let i=0;i<=t;i++){let o=this.createStar();o.style.top=`${this.rand()*100}%`,o.style.left=`${this.rand()*100}%`,o.style.animationDelay=`${this.rand()*8}s`,e.appendChild(o)}}}).create()}createContent(){const e=document.createElement("div");e.classList.add("content"),e.innerHTML=`
    ...
    `,document.body.append(e)}}class z{constructor(e,t){d(this,"view");d(this,"controller");this.view=e,this.controller=t}}const I=new z(new P,new O);I.view.renderUI();I.controller.control();
